...
export function MultiFactorAuthSetupDialog(props: { userId: string }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <DialogHeader>
          <DialogTitle>二段階認証を設定</DialogTitle>
    ...
    return (
      <div className={'flex w-full flex-col space-y-2'}>
        <Alert variant={'destructive'}>
          ...
          <AlertTitle>QRコードの生成に失敗しました</AlertTitle>

          <AlertDescription>
            QRコードの生成中にエラーが発生しました。もう一度お試しください。
          </AlertDescription>
        </Alert>
...
function ErrorAlert() {
  return (
    <Alert variant={'destructive'}>
      ...
      <AlertTitle>設定に失敗しました</AlertTitle>

      <AlertDescription>
        二段階認証の設定中にエラーが発生しました。もう一度お試しください。
      </AlertDescription>
    </Alert>
  );
}
