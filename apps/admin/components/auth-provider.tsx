...
export function AuthProvider(props: React.PropsWithChildren) {
  ...
  useEffect(() => {
    const checkSession = async () => {
      ...
      console.log('[AUTH-PROVIDER-ADMIN] Current session state:', {
  ...
  useEffect(() => {
    if (typeof document !== 'undefined') {
      console.log('[AUTH-PROVIDER-ADMIN] All cookies:', document.cookie);
      ...
      console.log('[AUTH-PROVIDER-ADMIN] Auth cookies:', authCookies);
    }
  }, []);
