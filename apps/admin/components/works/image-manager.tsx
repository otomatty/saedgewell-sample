  ...
  return (
    ...
    >
      ...
      <button
        ...
        {...listeners}
        type="button"
        className="cursor-grab touch-none pt-1 text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
        aria-label="画像を並び替え"
      >
